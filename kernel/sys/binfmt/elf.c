...
static int binfmt_elf32_load(proc_t *proc, struct inode *file)
{
    int err = 0;
...
static int binfmt_elf64_load(proc_t *proc, struct inode *file)
{
    int err = 0;
...
int binfmt_elf_load(proc_t *proc, struct inode *file)
{
    ...
    switch (hdr.class) {
        case 1:
            return binfmt_elf32_load(proc, file);
        case 2:
            return binfmt_elf64_load(proc, file);
